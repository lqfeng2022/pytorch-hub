export default [
  ...
  { id: 10, 
    ...
    items: [
      ...
      { id: 3, name: "- Patch Embedding (Epat)", link: "patch-embedding" },
      { id: 4, name: "-- Class Token Embedding", link: "class-token-embedding" },
      { id: 5, name: "- Positional Embedding (Epos)", link: "positional-embedding" },
      { id: 6, name: "- Transformer Encoder", link: "transformer-encoder" },
      { id: 7, name: "-- Attention Mechanism", link: "attention-mechanism" },
      { id: 8, name: "-- Multi-Head Self-Attention (MHA)", link: "multi-head-self-attention" },
      { id: 9, name: "-- Layer Normalization (LN)", link: "layer-normalization" },
      { id: 10, name: "-- Residual Connection (+)", link: "residual-connection" },
      { id: 11, name: "-- Multi-Layer Perceptron (MLP)", link: "multi-layer-perceptron" },
      { id: 12, name: "-- Perceptron", link: "perceptron" },
      { id: 13, name: "-- Dropout Layer", link: "dropout-layer" },
      { id: 14, name: "- Classifier", link: "classifier" },
      { id: 15, name: "- Activation Function (GeLU)", link: "activation-function" },
    ],
    description: [
      { id: 1, 
        title: "",
