export default [
  ...
  { id: 10, 
    ...
    items: [
      ...
      { id: 3, name: "Patch Embedding (Block 1)", link: "patch-embedding" },
      { id: 4, name: "- Class Token Embedding", link: "class-token-embedding" },
      { id: 5, name: "Positional Encoding (Block 2)", link: "positional-embedding" },
      { id: 6, name: "Transformer Encoder (Block 3)", link: "transformer-encoder" },
